<template>
  <div class="bg-stone-50 py-24 sm:py-32 border-t border-stone-200">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-center text-base/7 font-semibold text-sky-600">
        Deploy faster
      </h2>
      <p
          class="mx-auto mt-2 max-w-lg text-balance text-center text-4xl font-semibold tracking-tight text-stone-900 sm:text-5xl"
      >
      ...
      <div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
        <div class="relative lg:row-span-2">
          ...
          >
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p
                  class="mt-2 text-lg font-medium tracking-tight text-stone-900 max-lg:text-center"
              >
                Mobile friendly
              </p>
              <p
                  class="mt-2 max-w-lg text-sm/6 text-stone-600 max-lg:text-center"
              >
            ...
            >
              <div
                  class="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-stone-700 bg-gray-900 shadow-2xl"
              >
                <img
          ...
          <div
              class="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-stone-800/5 lg:rounded-l-[2rem]"
          />
        </div>
        <div class="relative max-lg:row-start-1">
          ...
          <div
              class="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-stone-800/5 max-lg:rounded-t-[2rem]"
          />
        </div>
        <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
          ...
          >
            <div class="px-8 pt-8 sm:px-10 sm:pt-10">
              <p
                  class="mt-2 text-lg font-medium tracking-tight text-stone-950 max-lg:text-center"
              >
                Security
              </p>
              <p
          ...
          <div
              class="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-stone-800/5"
          />
        </div>
        <div class="relative lg:row-span-2">
          <div
          ...
          >
            ...
            <div class="relative min-h-[30rem] w-full grow">
              <div
                  class="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-stone-900 shadow-2xl"
              >
                <div class="flex bg-stone-800/40 ring-1 ring-white/5">
                  <div class="-mb-px flex text-sm/6 font-medium text-stone-400">
                    <div
                        class="border-b border-r border-b-white/20 border-r-white/10 bg-white/5 px-4 py-2 text-white"
                    >
                      NotificationSetting.jsx
                    </div>
                    <div class="border-r border-stone-600/10 px-4 py-2">
                      App.jsx
                    </div>
                  </div>
                </div>
